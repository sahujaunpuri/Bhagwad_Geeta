...
public class UserMenu extends AppCompatActivity
    ...
    int id = 0,count = 0,chapter_no = 0,chapter_id = 0,diary_number = 0;
    DiaryDatabaseHandler diaryDatabaseHandler;
    SharedPreferences sharedPreferences,sharedPreferences1,sharedPreferences3;
    int count1 = 0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(flag == 0){
            ...
            View dialogLayout = getLayoutInflater().inflate(R.layout.activity_why_geeta,null);
...
*/
        edit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
             //Toast.makeText(UserMenu.this,chapter.getText().toString()+ ": "+learningText.getText().toString(),Toast.LENGTH_SHORT).show();
                ...
                //fragmentManager1.beginTransaction().replace(R.id.content_user_menu,chapter1,diaryFragment1.getTag()).commit();
            }
        });
       ...
       // final MediaPlayer mediaPlayer = MediaPlayer.create(this,R.raw.bgita);
        ...
        notify.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                fragmentManager.beginTransaction().replace(R.id.content_user_menu,notificationFragment,notificationFragment.getTag()).commit();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_diary) {
            ...
            fragmentManager2
                    ...
                    .replace(R.id.content_user_menu,settingsFragment,settingsFragment.getTag())
                    .commit();
            ...
            button2.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    rate1.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View v) {
                            rate1.setColorFilter(R.color.chakracolor);
                        }
                    });
                    rate2.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            rate1.setColorFilter(R.color.chakracolor);
                            rate2.setColorFilter(R.color.chakracolor);
                    ...
                    rate3.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            rate1.setColorFilter(R.color.chakracolor);
                            rate2.setColorFilter(R.color.chakracolor);
                            rate3.setColorFilter(R.color.chakracolor);
                    ...
                    rate4.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            rate2.setColorFilter(R.color.chakracolor);
                            rate3.setColorFilter(R.color.chakracolor);
                            rate4.setColorFilter(R.color.chakracolor);
                    ...
                    rate5.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            rate3.setColorFilter(R.color.chakracolor);
                            rate4.setColorFilter(R.color.chakracolor);
                            rate5.setColorFilter(R.color.chakracolor);
...
// Use TaskStackBuilder to build the back stack and get the PendingIntent
    ...
    protected void onResume() {
        super.onResume();
        if ((getSupportActionBar()!= null)||(getSupportActionBar().isShowing()==false)){
